...
class Escalation(Base):
    ...
    escalated_to: Mapped[int | None] = mapped_column(Integer, ForeignKey("users.id", ondelete="SET NULL"), nullable=True)
    ...
    __table_args__ = (
        Index("idx_escalations_sev_status", "severity", "status"),
    )
