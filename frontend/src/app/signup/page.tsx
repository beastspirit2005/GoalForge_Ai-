...
export default function SignupPage() {
  ...
  return (
    <div className="relative grid min-h-screen place-items-center overflow-hidden p-6 bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 selection:bg-indigo-500/10 selection:text-indigo-900 transition-colors duration-300">
      ...
      <div className="relative z-10 w-full max-w-lg overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-xl shadow-slate-100 dark:shadow-none">
        <div className="flex flex-col justify-center bg-slate-50/50 dark:bg-slate-900/40 p-8">
          ...
          {success ? (
            <div className="mt-8 flex flex-col items-center justify-center text-center p-6 border border-emerald-200 dark:border-emerald-900/30 bg-emerald-50 dark:bg-emerald-950/20 rounded-xl">
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="pt-2">
                <p className="text-[12px] font-semibold text-slate-700 dark:text-slate-300 mb-2">Select your role</p>
                    ...
                    return (
                      <button
                        ...
                        className={`group relative flex flex-col items-center justify-center rounded-xl border p-4 transition-all duration-300 ${
                          isSelected ? `${r.border} ${r.bg} ring-2 ring-indigo-500/50 dark:ring-indigo-500/30` : 'border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 hover:border-slate-300 dark:hover:border-slate-700'
                        }`}
                      ...
                      >
                        ...
                        <p className="mt-2 text-[12px] font-bold text-slate-800 dark:text-slate-250">{r.label}</p>
                      </button>
                    )
                  })}
                </div>
              ...
              <p className="text-center text-[12px] text-slate-500 dark:text-slate-400 font-medium pt-2">
